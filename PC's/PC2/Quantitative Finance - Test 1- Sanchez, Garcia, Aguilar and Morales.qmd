...
We will download the dataset from the following link: [Crypto dataset](https://www.kaggle.com/sudalairajkumar/cryptocurrencypricehistory).
The dataset contains historical data on the price of cryptocurrencies.
```{r}
...
Plot the data and explain the characteristics this process displays.
