...
# Playing one time and reshuffling the discard pile

```{r}
game <- initialize_game(num_cards = 73, number_of_players = 1, min_discard_pile = 1) |> 
      shuffle_discard_pile() |> 
      simulate_and_empty_hand(player_id = "1")

glimpse(game)
```

# Playing many times and reshuffling the discard pile
...
# Playing one time without reshuffling the discard pile
...
# Playing many times without reshuffling the discard pile
...
Include additional code snippets, data visualizations, or any supplementary information that adds value to the document. Tests \## Test 1
