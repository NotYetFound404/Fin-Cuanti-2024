...
n_games <- 1000
plan(multisession)  # Use multiple processes for parallelization
played_games <- future_map(1:n_games, ~ initialize_game(num_cards = 73, number_of_players = 1, min_discard_pile = 1) |> shuffle_discard_pile() |> simulate_game("1"))
head(played_games)
