...
#--------------
#Testing a sma200 with quantstrat for 1 pair
...
# StockA_StockC_MA <- SMA(StockA_StockC, n = 200)
# edit(SMA)
...
#               arguments = list(x = quote(mktdata), n = 200), 
#               
#               # Label your indicator SMA200
#               label = "SMA200")
# 
# test <- applyIndicators(strategy = strategy.st, mktdata = get(symbols))
#all(test$SMA.SMA200 %in% StockA_StockC_MA)
