library(shiny)
shinyUI(
  navbarPage("Financial Simulations",
             ...
             tabPanel("Vasicek Model",
                      sidebarLayout(
                        sidebarPanel(
                          numericInput("n_vasicek", "Number of Steps:", value = 100),
                          numericInput("m_vasicek", "Number of Paths:", value = 100),
                          numericInput("T_vasicek", "Time Horizon (years):", value = 1),
                          numericInput("alpha_vasicek", "Alpha:", value = 0.4),
                          numericInput("b_vasicek", "b:", value = 0.04),
                          numericInput("sigma_vasicek", "Sigma:", value = 0.1),
                          actionButton("run_vasicek", "Run Simulation")
                        ),
                        mainPanel(
                          plotOutput("plot_vasicek"),
                          br(),
                          h3("Statistics of Interest Rates"),
                          tableOutput("stats_table"),
                          br(),
                          h3("Histogram of Interest Rates"),
